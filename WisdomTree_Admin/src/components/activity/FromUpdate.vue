...
import { editActivityConfig } from '@/common/interfaces/activity.interface'
...
// 弹窗逻辑
const open = () => {
  ElMessageBox.confirm('确定要更新活动吗?', '提示', {
...
const addTreeType = async () => {
  ...
  try {
    const res = await requestWithRetry(
      editActivityConfig(form.value.id, {
        title: form.value.title,
        location: form.value.location,
        plannedCapacity: form.value.plannedCapacity,
...
<template>
  ...
  >
    <el-form-item label="活动标题" prop="title">
      <el-input v-model="form.title" placeholder="输入树木学名" />
    </el-form-item>
    <el-form-item label="活动地点" prop="location">
      <el-input v-model="form.location" placeholder="输入树木俗名" />
    </el-form-item>
    <el-form-item label="活动目前人数" prop="plannedCapacity">
      <el-input-number :disabled="true" v-model="form.currentCapacity" />
    </el-form-item>
    <el-form-item label="活动设定人数" prop="plannedCapacity">
      <el-input-number v-model="form.plannedCapacity" :min="form.currentCapacity" />
    </el-form-item>
    <!-- 活动时间段 -->
    ...
    <el-button type="primary" @click="submitForm(ruleFormRef)">更新活动</el-button>
  </el-form>
</template>
