...
import { updateProductConfig } from '@/common/interfaces/Product.interface'
...
// 弹窗逻辑
const open = () => {
  ElMessageBox.confirm('确定要修改产品信息吗?', '提示', {
...
const updateProduct = async () => {
  ...
  try {
    const res = await requestWithRetry(updateProductConfig(props.productID, form.value))
    // 重置表单
...
<template>
  ...
  >
    ...
    <el-button type="primary" @click="submitForm(ruleFormRef)">修改产品信息</el-button>
  </el-form>
</template>
